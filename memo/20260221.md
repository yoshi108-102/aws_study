...
```
とある。でもこの行削除してもなんか変わんなかった
depends onをつけると、リソースの依存関係を明示することができるらしい
消しても動くのはたまたま...
resourceの上下関係をいじってもエラーを吐かないので、単純に上から逐次実行しているわけでもなさそう
